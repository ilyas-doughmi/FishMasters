...
<head>
    <meta charset="UTF-8">
    <title>Nouveau Règlement | FishAdmin</title>
    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <div class="flex-1 flex flex-col lg:pl-64 h-full w-full">
            ...
            <header class="h-20 bg-white border-b border-slate-200 flex items-center justify-between px-6 lg:px-10">
                <h1 class="text-xl font-bold text-slate-800">Créer un règlement</h1>
            ...
            <main class="flex-1 overflow-y-auto p-6 lg:p-10">
                <div class="max-w-3xl mx-auto">
                    ...
                    <form action="/fishmasters/index.php?url=Admin/rules_create" method="POST"
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <input type="text" name="ruleName" placeholder="Ex: Scoring Mer Standard" required
                            ...
                            <div>
                                ...
                                <textarea name="ruleDescription" rows="4"
                                    placeholder="Ex: Attribution des points selon la taille et l'espèce du poisson"
                                    required
                                    class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:border-accent focus:ring-2 focus:ring-accent/20 outline-none transition-all resize-none"></textarea>
                            </div>
                        </div>
