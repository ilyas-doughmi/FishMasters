...
<body class="bg-white text-slate-900 h-screen overflow-hidden">
    ...
    <div class="flex h-full w-full">
        ...
        <div
            class="w-full lg:w-1/2 flex flex-col justify-center px-8 md:px-20 lg:px-24 bg-white z-10 overflow-y-auto py-12">
            ...
            <form action="/fishmasters/auth/create" method="POST" class="space-y-4">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="full_name" required placeholder="Ilyas Doughmi"
                            class="w-full px-4 py-3 rounded-xl border border-slate-200 focus:border-primary focus:ring-2 focus:ring-primary/20 outline-none transition-all placeholder:text-slate-400">
                    </div>
                    <div>
                ...
                <div class="pt-2">
                    <label class="flex items-start gap-3 cursor-pointer group">
                        ...
                        <span class="text-sm text-slate-600">J'accepte les <a href="#"
                                class="text-primary font-semibold hover:underline">Conditions d'utilisation</a> et la <a
                                href="#" class="text-primary font-semibold hover:underline">Politique de
                                confidentialité</a>.</span>
                    </label>
                </div>

                <button type="submit"
                    class="w-full bg-primary hover:bg-sky-600 text-white font-bold py-3.5 rounded-xl transition-all shadow-lg shadow-primary/20 hover:shadow-primary/30 transform hover:-translate-y-0.5 mt-4">
                    Créer mon compte
                </button>
            </form>
        ...
        <div class="hidden lg:block w-1/2 relative bg-slate-50">
            <img src="https://images.unsplash.com/photo-1544551763-8dd44758c2dd?q=80&w=2070&auto=format&fit=crop"
                class="absolute inset-0 w-full h-full object-cover">
            <div
                class="absolute inset-0 bg-gradient-to-t from-black/60 via-black/20 to-transparent flex flex-col justify-end p-20 text-white">
                <blockquote class="text-2xl font-medium leading-relaxed mb-4">
                    "Rejoignez des milliers de passionnés et accédez aux meilleures zones de pêche surveillées et aux
                    compétitions exclusives."
                </blockquote>
                <div class="flex items-center gap-4">
                    <div class="flex -space-x-3">
                        ...
                        <div
                            class="w-10 h-10 rounded-full border-2 border-white bg-primary flex items-center justify-center text-[10px] font-bold">
                            +2k</div>
                    </div>
